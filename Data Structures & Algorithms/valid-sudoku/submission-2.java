class Solution {
    public boolean isValidSudoku (char[][] board) {
        ...
        if(!checkBox(0, 2, board)) return false;
        if(!checkBox(1, 0, board)) return false;
        if(!checkBox(1, 1, board)) return false;
        if(!checkBox(1, 2, board)) return false;
        if(!checkBox(2, 0, board)) return false;
        if(!checkBox(2, 1, board)) return false;
        if(!checkBox(2, 2, board)) return false;
        return true;
    }
